  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Build your ideas, business, and creativity with a single platform. Horizon Hosting unifies the power of AI, design, and automation in one place."
        />
      </Helmet>
      ...
      <div className="bg-white">
            ...
            <div className="flex items-center justify-between h-16">
              ...
              <nav className="hidden md:flex items-center gap-8">
                <a
                  ...
                  className="text-gray-700 hover:text-[#0573AC] transition-colors font-medium"
                >
                  Pricing
                </a>
                <a
        ...
        <section
          ...
          style={{
            backgroundImage:
              "url('https://horizons-cdn.hostinger.com/eb5db8c3-45ff-433f-8da7-9e43c8d72761/ca33ea721d182fd90471e02244b5186c.webp')",
        ...
        >
          <div className="container relative z-10">
            ...
            >
              <h1
                className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#013353] mb-6"
                style={{
              ...
              >
                Build your ideas, business, and creativity with a single platform. Horizon Hosting unifies
                the power of AI, design, and automation in one place.
              </p>
          ...
          <div className="container">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <nav className="flex gap-6 text-sm">
                <a href="/about" className="hover:text-[#0573AC] transition-colors">
                  About
                </a>
                <a href="/terms" className="hover:text-[#0573AC] transition-colors">
                  Terms
                </a>
                <a href="/privacy" className="hover:text-[#0573AC] transition-colors">
                  Privacy
                </a>
                <a href="/contact" className="hover:text-[#0573AC] transition-colors">
                  Contact
                </a>
              </nav>
